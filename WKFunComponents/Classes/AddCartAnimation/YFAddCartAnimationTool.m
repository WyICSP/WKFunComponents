...
#import "YFAddCartAnimationTool.h"

@interface YFAddCartAnimationTool()<CAAnimationDelegate>

@end

@implementation YFAddCartAnimationTool

#pragma mark - instancetype
+ (instancetype)shareTool
{
    return [[YFAddCartAnimationTool alloc]init];
}
